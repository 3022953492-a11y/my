...
for i, layer in enumerate(graph_encoder.node_encoder):
    if hasattr(layer, 'in_features'):
        print(f"  层{i}: {layer}, 输入维度: {layer.in_features}, 输出维度: {layer.out_features}")
